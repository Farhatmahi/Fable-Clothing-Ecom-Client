        ...
        <div className="">
          ...
          <div className="my-8">
            {product_size.map((size) => (
              <button onClick={() => {handleSize(size)}} className="btn btn-square btn-outline rounded-none ml-2">
                {size}
              </button>
            ))}
          </div>
          <div className="flex flex-col lg:flex-row">
            <button onClick={handleAddToCart} className="btn bg-black lg:btn-wide text-white">
              Add to cart
            </button>
